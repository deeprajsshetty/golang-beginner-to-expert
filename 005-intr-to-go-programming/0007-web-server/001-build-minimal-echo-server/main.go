...
/*
Input:
go build the-go-programming-language/002-intr-to-go-programming/0007-web-server/001-build-minimal-echo-server/main.go

main exe file will be generated in root folder. Move that particular exe to
./the-go-programming-language/002-intr-to-go-programming/0007-web-server/001-build-minimal-echo-server/ path.

Run Server
./the-go-programming-language/002-intr-to-go-programming/0007-web-server/001-build-minimal-echo-server/main http://localhost:8000
